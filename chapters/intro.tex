...
\begin{figure}[H]
  \centering
  \placeholder{fig\_bg\_news.png}{ภาพข่าวแสดงกรณีมะเร็งช่องปากและการวินิจฉัยล่าช้าในชนบทไทย (สไลด์ 3)}
...
\begin{figure}[H]
  ...
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \placeholder{fig\_bg\_lesion1.png}{ภาพทางคลินิก ภาพซ้าย (สไลด์ 4)}
    \caption{รอยโรคช่องปาก ตัวอย่างเคสที่ 1}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\linewidth}
    \centering
    \placeholder{fig\_bg\_lesion2.png}{ภาพทางคลินิก ภาพขวา (สไลด์ 4)}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.65\linewidth}
    \placeholder{fig\_bg\_lesion\_annotated.png}{ภาพทางคลินิกพร้อม Annotation สีเหลือง (สไลด์ 5)}
  \end{minipage}
...
\begin{figure}[H]
  \centering
  \placeholder{fig\_bg\_stats\_chart.png}{กราฟสถิติรอยโรคช่องปากระดับประเทศ ปีงบประมาณ 2559 (สไลด์ 6)}
...
\begin{figure}[H]
  \centering
  \placeholder{fig\_bg\_registry\_table.png}{ตารางจำนวนทันตแพทย์เฉพาะทาง ราชวิทยาลัยทันตแพทย์ (สไลด์ 7)}
...
\begin{figure}[H]
  \centering
  \placeholder{fig\_aidoc\_screenshot.png}{หน้าจอระบบ AIDOC เฟส 1 (สไลด์ 8)}
...
\begin{figure}[H]
  ...
  \begin{minipage}{0.72\linewidth}
    \placeholder{fig\_legacy\_arch.png}{Diagram สถาปัตยกรรม Flask Monolith (สไลด์ 9/18)}
  \end{minipage}
...
\begin{itemize}[leftmargin=1.8em, itemsep=3pt]
  ...
  \item \textbf{Health Monitoring:} ตรวจสอบสถานะต่อเนื่อง
        เปิด Auto-Switch ภายใน $<2\,\text{s}$
\end{itemize}
...
\begin{itemize}[leftmargin=1.8em, itemsep=3pt]
  ...
  \item \textbf{RBAC} ครอบคลุม 6 บทบาท:
...
\begin{tcolorbox}[graybox]
  ...
  \begin{tabularx}{\linewidth}{@{}>{\bfseries\color{primaryblue}}p{0.26\linewidth}X@{}}
    Hybrid Mobile Platform &
      อินเทอร์เฟซที่ใช้งานง่ายผ่าน LINE Chatbot และ Web Dashboard
...
\begin{enumerate}[leftmargin=1.8em, label=\textbf{\arabic*.}, itemsep=6pt]
  \item \textbf{พัฒนาและทดสอบระบบ AI คัดกรอง} OPMD/OSCC ให้มีความแม่นยำสูง
        ใช้งานได้ในภาคสนาม และเป็นที่ยอมรับของทันตแพทย์เฉพาะทาง
